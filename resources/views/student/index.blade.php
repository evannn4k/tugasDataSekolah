    ...
    <div class="container mx-auto px-4">
        ...
        <div class="bg-white rounded-2xl p-4 flex flex-col gap-4">
            ...
            <div class="w-full flex justify-between items-center">
                ...
                <a href="" class="text-sm bg-blue-500 p-3 flex items-center gap-2 text-white rounded-xl duration-150 ease-in-out hover:scale-102 hover:bg-blue-500/90 active:scale-99"><i class="fa-solid fa-plus"></i> Add Student</a>
            </div>

            <div class="w-full grid grid-cols-4 gap-4">
                <div class="border border-gray-200 px-4 py-6 rounded-xl flex flex-col gap-2">
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody>
                            <tr class="border-b border-gray-200 hover:bg-gray-50">
                                <td class="px-2 py-auto text-center">1</td>
                                <td class="px-2 py-2">
                                    <img src="{{ asset("assets/images/logo-skamuhi.png") }}" alt="" class="h-10">
                                </td>
                                <td class="px-2 py-auto">Evan</td>
                                <td class="px-2 py-auto">76513451432</td>
                                <td class="px-2 py-auto">evan@gmail.com</td>
                                <td class="px-2 py-auto">
                                    <a class="bg-cyan-100 text-cyan-600 py-1 px-3 rounded-full">PPLG</a>
                                </td>
